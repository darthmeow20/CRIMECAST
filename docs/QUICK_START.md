...
| `python tests/test_project.py` | Check project health |
...
- [ ] Run health check: `python tests/test_project.py`
...
5. **Want to understand?** → Read `docs/PROJECT_GUIDE.md`
6. **Need deep dive?** → Read `docs/DISTILBERT_GUIDE.md` or `docs/SENTIMENT_TN_DISTRICTS.md`
