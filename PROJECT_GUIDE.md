...
**Good news — 2023 data is publicly available in nearly identical format** (see links below). 2024 NCRB national data has been released; full district-level tables are patchier.
